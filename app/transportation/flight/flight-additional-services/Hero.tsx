...
const Hero = () => {
                                ...
                                <div className='min-h-[170px] pb-[50px] h-auto flex flex-col ml-[30px] mt-[45px] box-border w-[95%] bg-transparent border-[#D9DBE9] border-[0.5px] rounded-[12px]'>
                                    ...
                                    <div className='flex justify-around items-center mt-[30px] w-full'>
                                        <div className='flex flex-col w-[60%] space-y-5 items-start'>
                                            ...
                                            <div className='h-[220px] box-border flex flex-col justify-center items-center w-[100%] bg-transparent border-[#D9DBE9] border-[0.5px] rounded-[12px]'>
 ...
 shadow-[0_4px_0_#4C3A00] px-6 py-2 hover:bg-white hover:translate-y-[2px] hover:shadow-[0_2px_0_#4C3A00] transition-all duration-200'>
                                        ...
                                        <div className='h-[550px] box-border w-[30%] bg-transparent border-[#D9DBE9] border-[0.5px] rounded-[12px]'>
                                            <div className='h-[45px] flex justify-start box-border items-center w-full bg-[#00BBBB] text-white text-[1.5rem] p-[30px] '>Your Bus Ticket</div>

                                            <div className='flex justify-between items-start w-full mt-[30px]'>
                                                <div className='h-full text-[0.9rem] p-[10px] w-[45%] flex flex-col gap-y-2 bg-transparent'>
                                                ...
                                                <div className='h-full p-[10px] text-[0.9rem] items-end w-[45%] flex flex-col gap-y-3 bg-transparent'>
