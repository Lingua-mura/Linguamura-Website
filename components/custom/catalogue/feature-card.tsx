...
export function FeatureCard({ title, description, imageSrc, buttonText, href }: FeatureCardProps) {
    return (
        <Card className="group relative overflow-hidden border-0 w-[311px] min-h-[486px]">
            <div className="relative h-[306px]">
                ...
                />
                <h2 className="absolute bottom-6 left-6 text-2xl font-bold text-white z-20">
                    {title}
                </h2>
            </div>
            <CardContent className="px-0 py-4 space-y-5">
